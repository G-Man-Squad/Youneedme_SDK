...
void CNPC_WpnScanner::Precache()
{
	...
	PrecacheScriptSound("NPC_WpnScanner.Alert");
	PrecacheScriptSound("NPC_WpnScanner.DiveBomb");
...
char *CNPC_WpnScanner::GetScannerSoundPrefix(void)
{
	return "NPC_WpnScanner";
}